...
export async function crawl() {
    ...
    await checkAnnouncements(page).catch(() =>
        renderError("Cannot fetch announcements!")
    );
    ...
    await browser.close().catch(() => renderError("EDUX seems to be down!"));
}
